...
private:
    ...
    __gnu_pbds::priority_queue<pair<int, int>, greater<pair<int, int>>> small;
    __gnu_pbds::priority_queue<pair<int, int>, less<pair<int, int>>> big;
public:
    StockPrice() {}
    ...
    void update(int timestamp, int price) {
        chmax(n, timestamp);
        ti[timestamp] = price;
        small.push({price, timestamp});
        big.push({price, timestamp});
    }
